...
5. Кнопка "Обновить" — полный перезапуск приложения с нуля (новый процесс через subprocess,
   безопасно для собранного PyInstaller .exe — os.execl там ломает C-расширения вроде matplotlib).
